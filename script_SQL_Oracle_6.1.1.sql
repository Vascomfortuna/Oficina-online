-- v.6.1.1(30.01.2017)
-- adicionado um modelo de restricao, CHECK_GENERO -> tabela Clientes, limita o estado a M/F;
...
VALUES
('João', 'Delgado', 'M', 961236819, 'joaoTeste@gmail.com','apenas teste');

INSERT INTO BD_CLIENTES
(PRIMEIRONOME, ULTIMONOME, GENERO, TELEMOVEL, EMAIL, PASSWORD)
VALUES
('Sandro', 'Marques', 'M', 961125622, 'sandroTeste@gmail.com','apenas teste');

INSERT INTO BD_CLIENTES
(PRIMEIRONOME, ULTIMONOME, GENERO, TELEMOVEL, EMAIL, PASSWORD)
VALUES
('Vasco', 'Fortuna', 'M', 961531819, 'vascoTeste@gmail.com','apenas teste');
