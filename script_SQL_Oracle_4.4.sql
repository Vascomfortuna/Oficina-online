...
ALTER TABLE BDA_1010985.BD_REPARACOES_OCORRENCIAS ADD CONSTRAINT FK_ID_OCORRENCIAS FOREIGN KEY ( ID_OCORRENCIAS ) REFERENCES BDA_1010985.BD_OCORRENCIAS ( IDOCORRENCIA ) NOT DEFERRABLE ;
ALTER TABLE BDA_1010985.BD_REPARACOES_OCORRENCIAS ADD CONSTRAINT FK_ID_REPARACAO_TIPO FOREIGN KEY ( ID_REPARACAO_TIPO ) REFERENCES BDA_1010985.BD_REPARACOES_TIPOS ( IDREPARACAOTIPO ) NOT DEFERRABLE ;
